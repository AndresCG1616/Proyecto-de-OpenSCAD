...
cajaSCTapa(largo=100,ancho=80,alto=40,espesor=3,dientes=8,modo=1);
// #### EStoy modificando equis de ###
     // MEDIDAS CAJA KARLA cube([100,80,40]);// #### EStoy modificando equis de ###
     //cube([largo,ancho,alto],center=true);],center=true);
